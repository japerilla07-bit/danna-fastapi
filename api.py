...
LS_VARIANT_MAP = {
    os.environ.get("LEMONSQUEEZY_VARIANT_DAILY",   "1519274"): "daily_pass",
    os.environ.get("LEMONSQUEEZY_VARIANT_WEEKLY",  "1519276"): "weekly_pro",
    os.environ.get("LEMONSQUEEZY_VARIANT_MONTHLY", "1519278"): "monthly",
}
